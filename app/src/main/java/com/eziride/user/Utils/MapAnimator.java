...
//        }
        ...
        PolylineOptions optionsBackground = new PolylineOptions().add(bangaloreRoute.get(0)).color(Color.parseColor(context.getResources().getString(0+R.color.text_red))).width(10);
        backgroundPolyline = googleMap.addPolyline(optionsBackground);

        optionsForeground = new PolylineOptions().add(bangaloreRoute.get(0)).color(Color.parseColor(context.getResources().getString(0+R.color.text_red))).width(10);
