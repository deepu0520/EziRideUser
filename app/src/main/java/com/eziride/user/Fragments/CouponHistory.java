...
import com.eziride.user.Models.CouponHistoryData;
...
public class CouponHistory extends Fragment {
    ...
    public void getHistoryList() {
        ...
        JsonArrayRequest jsonArrayRequest = new JsonArrayRequest(URLHelper.base + URLHelper.GET_COUPON_HISTORY, new Response.Listener<JSONArray>() {
            @Override
