...
import com.eziride.user.Fragments.OnGoingTrips;
import com.eziride.user.Fragments.PastTrips;
...
public class HistoryActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        tabTitles = new String[]{getResources().getString(R.string.past),
...
//      //  tabOne.setTextColor(getResources().getColor(R.color.button_bg_color));
...
//       // tabTwo.setTextColor(getResources().getColor(R.color.button_bg_color));
