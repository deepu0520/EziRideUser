        ...
        facebook_layout.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (isInternet) {
                    ...
                    builder.setMessage(getResources().getString(R.string.check_internet)).setCancelable(false);
                        ...
                        try {
                            ...
                            if (AccountKit.getCurrentAccessToken().getToken() != null) {
                                ...
                                if (loginBy.equalsIgnoreCase("facebook")) {
                                    login(accessToken, URLHelper.base + URLHelper.FACEBOOK_LOGIN, "facebook");
                                } else {
                                    login(accessToken, URLHelper.base + URLHelper.GOOGLE_LOGIN, "google");
                                }
                                //GoToMainActivity();
                            } else {
                                ...
                                if (AccessDetails.demo_build) {
                                    ...
                                    goToLogin = new Intent(ActivitySocialLogin.this, BeginScreen.class);
                                }
...
//                .addHeader("Authorization",""+SharedHelper.getKey(context, "token_type")+" "+SharedHelper.getKey(context, "access_token"))
    ...
    public void GoToBeginActivity() {
        ...
        if (AccessDetails.demo_build) {
            ...
            mainIntent = new Intent(ActivitySocialLogin.this, BeginScreen.class);
        }
