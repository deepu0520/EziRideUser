...
public class ChangePassword extends AppCompatActivity {
    ...
    private void changePassword(final String current_pass, final String new_pass, final String confirm_new_pass) {
        ...
        JsonObjectRequest jsonObjectRequest = new JsonObjectRequest(Request.Method.POST, URLHelper.base + URLHelper.CHANGE_PASSWORD_API, object, new Response.Listener<JSONObject>() {
            @Override
