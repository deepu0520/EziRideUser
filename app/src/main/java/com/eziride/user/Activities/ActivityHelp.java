...
public class ActivityHelp extends AppCompatActivity implements View.OnClickListener {
    ...
    private void findviewById() {
        ...
        brand_txt.setText(AccessDetails.siteTitle + " " + getString(R.string.help));
    }
...
//            startActivity(Intent.createChooser(intent, "Send Email"));
        ...
        if (v == imgPhone) {
            ...
            if (hasNetwork) {
                ...
                displayMessage(context.getResources().getString(R.string.no_network));
            }
        }
        if (v == imgWeb) {
            Intent browserIntent = new Intent(Intent.ACTION_VIEW, Uri.parse(URLHelper.base));
    ...
    public void getHelp() {
        ...
        JsonObjectRequest jsonObjectRequest = new JsonObjectRequest(Request.Method.GET, URLHelper.base + URLHelper.HELP, object, new Response.Listener<JSONObject>() {
            @Override
    ...
    public void GoToBeginActivity() {
        ...
        if (AccessDetails.demo_build){
            ...
            mainIntent = new Intent(ActivityHelp.this, BeginScreen.class);
        }
