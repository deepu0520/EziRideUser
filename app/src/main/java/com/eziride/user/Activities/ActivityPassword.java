...
public class ActivityPassword extends AppCompatActivity {
    ...
    Button nextICON;
    EditText password;
    MyTextView register, forgetPassword, showPassword;
            ...
            JsonObjectRequest jsonObjectRequest = new JsonObjectRequest(Request.Method.GET, URLHelper.base + URLHelper.UserProfile + "?device_type=android&device_id=" + device_UDID + "&device_token=" + device_token, object, new Response.Listener<JSONObject>() {
                ...
                public void onResponse(JSONObject response) {
                    ...
                    if (response.optString("picture").startsWith("http"))
                        ...
                        SharedHelper.putKey(context, "picture", URLHelper.avatar_base_url + response.optString("picture"));
    ...
    private void refreshAccessToken() {
        if (isInternet) {
            ...
            try {
                ...
                Log.e(TAG, "refreshAccessToken: " + SharedHelper.getKey(context, "refresh_token"));
                object.put("scope", "");
            } catch (JSONException e) {
                e.printStackTrace();
            }
    ...
    public void findViewByIdandInit() {
        ...
        showPassword = (MyTextView) findViewById(R.id.showpassword);
