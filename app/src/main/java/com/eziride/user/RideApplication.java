...
public class RideApplication extends Application {
    ...
    public static final String TAG = RideApplication.class
            .getSimpleName();

    private RequestQueue mRequestQueue;
    private ImageLoader mImageLoader;

    private static RideApplication mInstance;
    ...
    public void onCreate() {
        ...
        remoteConfigDefaults.put(ForceUpdateChecker.KEY_UPDATE_URL,
                "https://play.google.com/store/apps/details?id=com.eziride.user");
    ...
    public static synchronized RideApplication getInstance() {
        return mInstance;
    }
